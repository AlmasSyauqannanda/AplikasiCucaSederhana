...
Aplikasi ini digunakan untuk memudahkan pengguna memeriksa cuaca di berbagai kota secara sederhana, dengan opsi untuk memilih kota favorit dan menyimpan data cuaca.
## Features
...
- Pengguna dapat memasukkan nama kota pada kolom input untuk mencari informasi cuaca terkini di kota tersebut.
- Tombol "Cek Cuaca" digunakan untuk mengambil dan menampilkan data cuaca berdasarkan kota yang dicari.

2. Pemilihan Kota Favorit:

- Tersedia dropdown menu yang memungkinkan pengguna untuk memilih salah satu kota favorit.
- Fitur ini memudahkan pengguna mengakses informasi cuaca di kota-kota yang sering diperiksa tanpa harus mengetik ulang.

3. Tabel Informasi Cuaca:

- Menampilkan data kota dan cuaca dalam bentuk tabel.
- Berguna untuk melihat ringkasan data cuaca dari beberapa kota secara sekaligus.

4. Menyimpan Data Cuaca:

- Tombol "Simpan Data" memungkinkan pengguna menyimpan informasi cuaca yang telah dicari atau dipilih.
- Fitur ini dapat digunakan untuk menyimpan riwayat atau referensi cuaca untuk kebutuhan tertentu.
...
- Komponen Utama: JFrame, JPanel, JLabel, JTextField, JButton, JComboBox, JTable.
## Source Code
